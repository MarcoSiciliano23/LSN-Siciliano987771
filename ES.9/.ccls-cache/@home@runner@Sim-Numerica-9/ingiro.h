...
public:
		...
		void Set_city(Random& rnd, const string& poligono);          // Imposta la città con coordinate casuali
...
public:
		Mappa(int ncity, Random& rnd, const string& poligono);
		~Mappa();
...
public:
		Genetica(int ncity, const string& poligono);
		~Genetica();
