...
int main() {
    ...
    vector<int> best_solutionC = geneC.Evoluzione(1000, "length_cerchio.dat");
    ...
    // Salvataggio delle coordinate delle città sulla mappa a cerchio
    vector<double> xC, yC;
    for (int i = 0; i < n_city; i++) {
        xC.push_back(MapC.GetCity(i).Get_Coord(0)); // Ottenere la coordinata x della città i-esima
        yC.push_back(MapC.GetCity(i).Get_Coord(1)); // Ottenere la coordinata y della città i-esima
    }

    // Apertura del file in modalità scrittura per salvare le coordinate delle città
    ...
    // Scrittura delle coordinate nel file
    ...
    // Apertura del file in modalità scrittura per salvare il percorso migliore
    ...
    // Salvataggio delle coordinate delle città sulla mappa a quadrato
    vector<double> xQ, yQ;
    for (int i = 0; i < n_city; i++) {
        xQ.push_back(Mapa.GetCity(i).Get_Coord(0)); // Ottenere la coordinata x della città i-esima
        yQ.push_back(Mapa.GetCity(i).Get_Coord(1)); // Ottenere la coordinata y della città i-esima
    }
