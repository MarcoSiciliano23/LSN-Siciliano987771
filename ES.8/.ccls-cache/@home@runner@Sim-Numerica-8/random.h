...
double Integra_metropolis(Energia H, Trial_wave_function psi, int num_steps, double step_size, double &variance);

	void SimulatedAnnealing(double &mu, double &sigma, double T_0, int num_steps, double step_size);
};
